...
import ch.derlin.easypass.multiline.MultiLineCellRenderer;
import ch.derlin.easypass.multiline.PasswordMultiCellRenderer;
import ch.derlin.easypass.multiline.TextAreaCellEditor;
 ...
 * ch.derlin.easypass.table. All the logic is implemented in the PassTableModel class.
 *
 * @author Lucy Linder
 * @date Dec 21, 2012
 */
public class PassTable extends JTable{
    ...
    /**
     * this method is called whenever the ch.derlin.easypass.table needs to be redrawn. It customs
    ...
    /**
     * returns an array of int representing the model indexes corresponding to the given ch.derlin.easypass.table
     * columns  indexes
     *
