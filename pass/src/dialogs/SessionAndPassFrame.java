...
public class SessionAndPassFrame extends javax.swing.JDialog {
    ...
    public SessionAndPassFrame(javax.swing.JFrame parent, String[] sessions)
    ...
    private void initComponents() {
        ...
        if( this.sessionList == null ){
            this.sessionCombo = new javax.swing.JComboBox<String>(
                    new String[]{ "choose..." } );
        }else{
    ...
    private void sessionComboActionPerformed( java.awt.event.ActionEvent evt ) {
        if( !( (String) this.sessionCombo.getSelectedItem() )
                .equals( "choose..." ) ){
    ...
    private void newSessionButtonActionPerformed( java.awt.event.ActionEvent evt ) {
        String newSession = (String) JOptionPane.showInputDialog( this,
                "New session name : ", "" );
        // the (?i) makes everything on the right case-insensitive
        if( newSession != null
                && newSession.matches( "^(?i)[a-z][a-z1-9\\._-]{2,}$" ) ){
            
            // if this session name doesn't already exist, show error message
            // and return
            for( int i = 0; i < this.sessionCombo.getItemCount(); i++ ){
                if( newSession.equals( this.sessionCombo.getItemAt( i ) ) ){
                    JOptionPane.showMessageDialog( this,
                            "This session name is already in use ", "error",
            ...
            this.sessionCombo.setSelectedIndex( this.sessionCombo
                    .getItemCount() - 1 );
    ...
    public static void main( String args[] ) {
        ...
        try{
            ...
            java.util.logging.Logger.getLogger(
                    SessionAndPassFrame.class.getName() ).log(
