...
import ch.derlin.easypass.manager.UndoManager;
...
public class PassFrame extends JFrame {
    ...
    boolean debug = true;
    private static String FAVICON_PATH = "easypass_favicon.ico";
    ...
    // the ch.derlin.easypass.table cells
    ...
    /**
     * *****************************************************************
     * constructor, acts as a ch.derlin.easypass.main method /
     * ******************************************************************
     */

    public PassFrame( Session session, PassLock lock ) {
        // initializes the ch.derlin.easypass.main Frame
        ...
        java.net.URL url = ClassLoader.getSystemResource( FAVICON_PATH );
        Image img = Toolkit.getDefaultToolkit().createImage(url);
        setIconImage( img );

        // creates the ch.derlin.easypass.main container
        ...
        //ch.derlin.easypass.table.setRowHeight( 30 );
        table.setStyle();
        table.setColSizes( ( int[] ) session.getConfigProperty( "column dimensions" ) );
        //settableColSizes();

        // sets the ch.derlin.easypass.undo ch.derlin.easypass.manager for CTRL Z
        ...
        // adds mouselistener to make the ch.derlin.easypass.table loose focus when click occurs
        // outside
        this.setMouseListener();

        // adds a listener to update the displayed row count when the ch.derlin.easypass.table
        // changes
        ...
        // PassExcelAdapter adapter = new PassExcelAdapter( ch.derlin.easypass.table );
        this.pack();
    ...
    /**
     * adds a mouselistener so that the ch.derlin.easypass.table cells loose focus and stop editing
     * when the user clicks outside of the ch.derlin.easypass.table
     */
    public void setMouseListener() {
        ...
        Toolkit.getDefaultToolkit().addAWTEventListener( new AWTEventListener() {
            ...
            public void eventDispatched( AWTEvent evt ) {
                ...
                // if the click was outside the ch.derlin.easypass.table, clear selection
    ...
    /**
     * returns the searchbox to filter the data in the ch.derlin.easypass.table (implementation
